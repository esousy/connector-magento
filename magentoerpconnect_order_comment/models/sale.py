...
from odoo.addons.connector.unit.mapper import (
    ...
    ImportMapper,
    ExportMapper)
from odoo.addons.magentoerpconnect.unit.binder import MagentoModelBinder
from odoo.addons.magentoerpconnect.unit.backend_adapter import (
    GenericAdapter,
)
...
class SaleCommentExportMapper(ExportMapper):
    ...
    def status(self, record):
        state = record.magento_sale_order_id.odoo_id.state
